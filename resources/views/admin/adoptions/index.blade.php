            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium">All Adoptions</h3>
                    </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            <div class="text-gray-500 dark:text-gray-400">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No adoptions</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">No adoption applications have been submitted yet.</p>
                            </div>
                        </div>
                    @endif
                </div>
