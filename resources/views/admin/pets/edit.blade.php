        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="admin-card overflow-hidden sm:rounded-lg">
                <div class="p-6 admin-text-primary">
                    <h3 class="text-lg font-medium admin-text-primary mb-4">Edit Pet Details</h3>
                    ...
                    <form method="POST" action="{{ route('admin.pets.update', $pet->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="behavior_description" name="behavior_description" class="block mt-1 w-full border rounded-md focus:outline-none admin-text-secondary" style="border-color: #CD5656; background-color: #FFF4EA;">{{ old('behavior_description', $pet->behavior_description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="user_id" name="user_id" class="block mt-1 w-full border rounded-md focus:outline-none admin-text-secondary" style="border-color: #CD5656; background-color: #FFF4EA;">
                            ...
                            <div class="grid grid-cols-3 gap-4 mt-2">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute top-1 right-1">
                                        <input type="checkbox" name="existing_photos_to_delete[]" value="{{ $photo->id }}" class="rounded border focus:outline-none" style="border-color: #CD5656; background-color: #FFF4EA;">
                                        <span class="text-sm admin-text-primary">Delete</span>
                                    </div>
                                    <div class="absolute bottom-1 left-1">
                                        <input type="radio" name="main_photo_id" value="{{ $photo->id }}" {{ $photo->is_main ? 'checked' : '' }} class="rounded border focus:outline-none" style="border-color: #CD5656; background-color: #FFF4EA;">
                                        <span class="text-sm admin-text-primary">Main</span>
                                    </div>
                                </div>
                                @endforeach
                            </div>
