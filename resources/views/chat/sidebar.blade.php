<div class="h-full flex flex-col">
    ...
    <div id="chat-user-list" class="chat-user-list flex-grow overflow-y-auto space-y-3 pr-2">
        ...
        <div id="no-chat-users" class="text-center py-10">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-300">No users online</h3>
            <p class="mt-1 text-xs text-gray-400">Check back later to chat with other users.</p>
        </div>
    </div>
</div>
