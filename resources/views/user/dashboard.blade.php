        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('user.applications.index') }}" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <a href="{{ route('user.adoption-gallery') }}" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Adopt a Friend</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Browse our gallery of available dogs</p>
                        </div>
                    </a>
