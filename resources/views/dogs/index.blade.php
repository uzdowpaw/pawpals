...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">Meet Our Dogs</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out">
            <a href="{{ route('dogs.show', $dog) }}">
                ...
                <img src="{{ asset('storage/' . $dog->photos->first()->path) }}" alt="{{ $dog->name }}" class="w-full h-56 object-cover">
                @else
                ...
                <div class="p-6">
                    ...
                    <p class="text-md text-gray-600 dark:text-gray-400">{{ $dog->breed }}</p>
